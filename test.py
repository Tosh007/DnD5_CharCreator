...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_Class.setItemText(0, _translate("MainWindow", "Bardbarian"))
        self.comboBox_Class.setItemText(1, _translate("MainWindow", "Bard"))
        self.comboBox_Class.setItemText(2, _translate("MainWindow", "Cleric"))
        self.comboBox_Class.setItemText(3, _translate("MainWindow", "Druid"))
        self.comboBox_Class.setItemText(4, _translate("MainWindow", "Fighter"))
        self.comboBox_Class.setItemText(5, _translate("MainWindow", "Monk"))
        self.comboBox_Class.setItemText(6, _translate("MainWindow", "Paladin"))
        self.comboBox_Class.setItemText(7, _translate("MainWindow", "Ranger"))
        self.comboBox_Class.setItemText(8, _translate("MainWindow", "Rogue"))
        self.comboBox_Class.setItemText(9, _translate("MainWindow", "Sorcerer"))
        self.comboBox_Class.setItemText(10, _translate("MainWindow", "Warlock"))
        self.comboBox_Class.setItemText(11, _translate("MainWindow", "Wizard"))
        self.comboBox_Race.setItemText(0, _translate("MainWindow", "Human"))
        self.comboBox_Race.setItemText(1, _translate("MainWindow", "Dwarf"))
        self.comboBox_Race.setItemText(2, _translate("MainWindow", "Elf"))
        self.comboBox_Race.setItemText(3, _translate("MainWindow", "Halfling"))
        self.comboBox_Race.setItemText(4, _translate("MainWindow", "Dragonborn"))
        self.comboBox_Race.setItemText(5, _translate("MainWindow", "Gnome"))
        self.comboBox_Race.setItemText(6, _translate("MainWindow", "Half-Elf"))
        self.comboBox_Race.setItemText(7, _translate("MainWindow", "Half-Orc"))
        self.comboBox_Race.setItemText(8, _translate("MainWindow", "Tiefling"))
