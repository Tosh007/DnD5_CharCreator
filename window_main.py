...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ComboBox_Subclass = QtWidgets.QComboBox(self.centralwidget)
        self.ComboBox_Subclass.setObjectName("ComboBox_Subclass")
        self.horizontalLayout_7.addWidget(self.ComboBox_Subclass)
        ...
        self.ComboBox_Race = QtWidgets.QComboBox(self.centralwidget)
        ...
        self.horizontalLayout_8.addWidget(self.Label_Initiative)
        ...
        self.horizontalLayout_8.addWidget(self.Label_MaxHP)
        self.Label_ArmorClass = QtWidgets.QLabel(self.centralwidget)
        self.Label_ArmorClass.setObjectName("Label_ArmorClass")
        self.horizontalLayout_8.addWidget(self.Label_ArmorClass)
        self.Label_Perception = QtWidgets.QLabel(self.centralwidget)
        self.Label_Perception.setObjectName("Label_Perception")
        self.horizontalLayout_8.addWidget(self.Label_Perception)
        self.gridLayout.addLayout(self.horizontalLayout_8, 1, 2, 1, 2)
        ...
        self.Label_EchoStrengthMod.setMinimumSize(QtCore.QSize(150, 0))
        self.Label_EchoStrengthMod.setObjectName("Label_EchoStrengthMod")
        self.verticalLayout_12.addWidget(self.Label_EchoStrengthMod)
        self.SpinBox_StrengthScore = QtWidgets.QSpinBox(self.frame_StrengthMod)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SpinBox_StrengthScore.sizePolicy().hasHeightForWidth())
        self.SpinBox_StrengthScore.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_12.addWidget(self.SpinBox_StrengthScore)
        ...
        self.checkBox_strength_saving_throw = QtWidgets.QCheckBox(self.frame_StrengthMod)
        self.checkBox_strength_saving_throw.setMouseTracking(False)
        self.checkBox_strength_saving_throw.setFocusPolicy(QtCore.Qt.NoFocus)
        self.checkBox_strength_saving_throw.setCheckable(True)
        self.checkBox_strength_saving_throw.setTristate(False)
        self.checkBox_strength_saving_throw.setObjectName("checkBox_strength_saving_throw")
        self.verticalLayout_2.addWidget(self.checkBox_strength_saving_throw)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Label_EchoDextMod.sizePolicy().hasHeightForWidth())
        self.Label_EchoDextMod.setSizePolicy(sizePolicy)
        self.Label_EchoDextMod.setMinimumSize(QtCore.QSize(150, 0))
        self.Label_EchoDextMod.setObjectName("Label_EchoDextMod")
        self.verticalLayout_13.addWidget(self.Label_EchoDextMod)
        self.SpinBox_DextScore = QtWidgets.QSpinBox(self.frame_DextMod)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SpinBox_DextScore.sizePolicy().hasHeightForWidth())
        self.SpinBox_DextScore.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_13.addWidget(self.SpinBox_DextScore)
        ...
        self.checkBox_dexterity_saving_throw = QtWidgets.QCheckBox(self.frame_DextMod)
        self.checkBox_dexterity_saving_throw.setMouseTracking(False)
        self.checkBox_dexterity_saving_throw.setFocusPolicy(QtCore.Qt.NoFocus)
        self.checkBox_dexterity_saving_throw.setCheckable(True)
        self.checkBox_dexterity_saving_throw.setTristate(False)
        self.checkBox_dexterity_saving_throw.setObjectName("checkBox_dexterity_saving_throw")
        self.verticalLayout_3.addWidget(self.checkBox_dexterity_saving_throw)
        ...
        self.Label_EchoConstMod.setMinimumSize(QtCore.QSize(150, 0))
        self.Label_EchoConstMod.setObjectName("Label_EchoConstMod")
        self.verticalLayout_17.addWidget(self.Label_EchoConstMod)
        ...
        self.verticalLayout_17.addWidget(self.SpinBox_ConstScore)
        ...
        self.checkBox_constitution_saving_throw = QtWidgets.QCheckBox(self.frame_ConstMod)
        self.checkBox_constitution_saving_throw.setMouseTracking(False)
        self.checkBox_constitution_saving_throw.setFocusPolicy(QtCore.Qt.NoFocus)
        self.checkBox_constitution_saving_throw.setCheckable(True)
        self.checkBox_constitution_saving_throw.setTristate(False)
        self.checkBox_constitution_saving_throw.setObjectName("checkBox_constitution_saving_throw")
        self.verticalLayout_4.addWidget(self.checkBox_constitution_saving_throw)
        ...
        self.Label_EchoIntelMod.setMinimumSize(QtCore.QSize(150, 0))
        self.Label_EchoIntelMod.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.Label_EchoIntelMod.setObjectName("Label_EchoIntelMod")
        self.verticalLayout_15.addWidget(self.Label_EchoIntelMod)
        self.SpinBox_IntelScore = QtWidgets.QSpinBox(self.frame_IntelMod)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SpinBox_IntelScore.sizePolicy().hasHeightForWidth())
        self.SpinBox_IntelScore.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_15.addWidget(self.SpinBox_IntelScore)
        ...
        self.checkBox_intelligence_saving_throw = QtWidgets.QCheckBox(self.frame_IntelMod)
        self.checkBox_intelligence_saving_throw.setMouseTracking(False)
        self.checkBox_intelligence_saving_throw.setFocusPolicy(QtCore.Qt.NoFocus)
        self.checkBox_intelligence_saving_throw.setCheckable(True)
        self.checkBox_intelligence_saving_throw.setTristate(False)
        self.checkBox_intelligence_saving_throw.setObjectName("checkBox_intelligence_saving_throw")
        self.verticalLayout_5.addWidget(self.checkBox_intelligence_saving_throw)
        ...
        self.Label_EchoWisdomMod.setMinimumSize(QtCore.QSize(150, 0))
        self.Label_EchoWisdomMod.setObjectName("Label_EchoWisdomMod")
        self.verticalLayout_14.addWidget(self.Label_EchoWisdomMod)
        self.SpinBox_WisdomScore = QtWidgets.QSpinBox(self.frame_WisdomMod)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SpinBox_WisdomScore.sizePolicy().hasHeightForWidth())
        self.SpinBox_WisdomScore.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_14.addWidget(self.SpinBox_WisdomScore)
        ...
        self.checkBox_wisdom_saving_throw = QtWidgets.QCheckBox(self.frame_WisdomMod)
        self.checkBox_wisdom_saving_throw.setMouseTracking(False)
        self.checkBox_wisdom_saving_throw.setFocusPolicy(QtCore.Qt.NoFocus)
        self.checkBox_wisdom_saving_throw.setCheckable(True)
        self.checkBox_wisdom_saving_throw.setTristate(False)
        self.checkBox_wisdom_saving_throw.setObjectName("checkBox_wisdom_saving_throw")
        self.verticalLayout_6.addWidget(self.checkBox_wisdom_saving_throw)
        ...
        self.Label_EchoCharismaMod.setMinimumSize(QtCore.QSize(150, 0))
        self.Label_EchoCharismaMod.setObjectName("Label_EchoCharismaMod")
        self.verticalLayout_16.addWidget(self.Label_EchoCharismaMod)
        self.SpinBox_CharismaScore = QtWidgets.QSpinBox(self.frame_CharismaMod)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SpinBox_CharismaScore.sizePolicy().hasHeightForWidth())
        self.SpinBox_CharismaScore.setSizePolicy(sizePolicy)
        ...
        self.verticalLayout_16.addWidget(self.SpinBox_CharismaScore)
        ...
        self.checkBox_charisma_saving_throw = QtWidgets.QCheckBox(self.frame_CharismaMod)
        self.checkBox_charisma_saving_throw.setMouseTracking(False)
        self.checkBox_charisma_saving_throw.setFocusPolicy(QtCore.Qt.NoFocus)
        self.checkBox_charisma_saving_throw.setCheckable(True)
        self.checkBox_charisma_saving_throw.setTristate(False)
        self.checkBox_charisma_saving_throw.setObjectName("checkBox_charisma_saving_throw")
        self.verticalLayout_7.addWidget(self.checkBox_charisma_saving_throw)
        ...
        self.label_4.raise_()
        self.gridLayout.addWidget(self.AbilityScoreGroup, 2, 0, 2, 3)
        self.gridLayout_2 = QtWidgets.QGridLayout()
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setObjectName("label_6")
        self.gridLayout_2.addWidget(self.label_6, 2, 2, 1, 1)
        self.treeWidget_proficiencies = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidget_proficiencies.setObjectName("treeWidget_proficiencies")
        self.treeWidget_proficiencies.headerItem().setText(0, "1")
        self.treeWidget_proficiencies.header().setVisible(False)
        self.gridLayout_2.addWidget(self.treeWidget_proficiencies, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.listWidget_inventory, 3, 0, 1, 1)
        self.treeWidget_spells = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidget_spells.setObjectName("treeWidget_spells")
        self.treeWidget_spells.headerItem().setText(0, "1")
        self.treeWidget_spells.header().setVisible(False)
        self.gridLayout_2.addWidget(self.treeWidget_spells, 3, 2, 1, 1)
        self.listWidget_traits = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_traits.setObjectName("listWidget_traits")
        self.gridLayout_2.addWidget(self.listWidget_traits, 1, 2, 1, 2)
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setObjectName("label_5")
        self.gridLayout_2.addWidget(self.label_5, 2, 1, 1, 1)
        self.tabWidget_specialProperties = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget_specialProperties.setObjectName("tabWidget_specialProperties")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.tabWidget_specialProperties.addTab(self.tab, "")
        self.gridLayout_2.addWidget(self.tabWidget_specialProperties, 1, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 0, 2, 1, 1)
        self.verticalLayout_19 = QtWidgets.QVBoxLayout()
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.treeWidget_languages = QtWidgets.QTreeWidget(self.centralwidget)
        self.treeWidget_languages.setObjectName("treeWidget_languages")
        self.treeWidget_languages.headerItem().setText(0, "1")
        self.treeWidget_languages.header().setVisible(False)
        self.verticalLayout_19.addWidget(self.treeWidget_languages)
        self.listWidget_profChoices = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_profChoices.setObjectName("listWidget_profChoices")
        item = QtWidgets.QListWidgetItem()
        self.listWidget_profChoices.addItem(item)
        self.verticalLayout_19.addWidget(self.listWidget_profChoices)
        self.gridLayout_2.addLayout(self.verticalLayout_19, 1, 1, 1, 1)
        ...
        self.action_saveAs_file = QtWidgets.QAction(MainWindow)
        self.action_saveAs_file.setObjectName("action_saveAs_file")
        self.menuDatei.addAction(self.action_new)
        self.menuDatei.addAction(self.action_open_file)
        self.menuDatei.addAction(self.action_save_file)
        self.menuDatei.addAction(self.action_saveAs_file)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Label_EchoStrengthMod.setText(_translate("MainWindow", "Strength"))
        self.checkBox_strength_saving_throw.setText(_translate("MainWindow", "Saving Throws"))
        self.checkBox_athletics.setText(_translate("MainWindow", "Athletics"))
        self.Label_EchoDextMod.setText(_translate("MainWindow", "Dexterity"))
        self.checkBox_dexterity_saving_throw.setText(_translate("MainWindow", "Saving Throws"))
        ...
        self.Label_EchoConstMod.setText(_translate("MainWindow", "Constitution"))
        self.checkBox_constitution_saving_throw.setText(_translate("MainWindow", "Saving Throws"))
        self.Label_EchoIntelMod.setText(_translate("MainWindow", "Intelligence"))
        self.checkBox_intelligence_saving_throw.setText(_translate("MainWindow", "Saving Throws"))
        ...
        self.Label_EchoWisdomMod.setText(_translate("MainWindow", "Wisdom"))
        ...
        self.checkBox_wisdom_saving_throw.setText(_translate("MainWindow", "Saving Throws"))
        ...
        self.Label_EchoCharismaMod.setText(_translate("MainWindow", "Charisma"))
        ...
        self.checkBox_charisma_saving_throw.setText(_translate("MainWindow", "Saving Throws"))
        ...
        __sortingEnabled = self.listWidget_profChoices.isSortingEnabled()
        self.listWidget_profChoices.setSortingEnabled(False)
        item = self.listWidget_profChoices.item(0)
        item.setText(_translate("MainWindow", "proficiency / spell choices"))
        self.listWidget_profChoices.setSortingEnabled(__sortingEnabled)
        ...
        self.action_saveAs_file.setText(_translate("MainWindow", "Speichern unter"))
        self.action_saveAs_file.setShortcut(_translate("MainWindow", "Ctrl+Shift+S"))
