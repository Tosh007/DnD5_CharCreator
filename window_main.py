...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.AbilityScoreGroup.setGeometry(QtCore.QRect(10, 60, 401, 521))
        ...
        self.checkBox = QtWidgets.QCheckBox(self.frame_StrengthMod)
        self.checkBox.setObjectName("checkBox")
        self.verticalLayout_2.addWidget(self.checkBox)
        self.checkBox_2 = QtWidgets.QCheckBox(self.frame_StrengthMod)
        ...
        self.checkBox_3 = QtWidgets.QCheckBox(self.frame_DextMod)
        self.checkBox_3.setObjectName("checkBox_3")
        self.verticalLayout_3.addWidget(self.checkBox_3)
        self.checkBox_9 = QtWidgets.QCheckBox(self.frame_DextMod)
        ...
        self.checkBox_10 = QtWidgets.QCheckBox(self.frame_DextMod)
        self.checkBox_10.setObjectName("checkBox_10")
        self.verticalLayout_9.addWidget(self.checkBox_10)
        self.checkBox_8 = QtWidgets.QCheckBox(self.frame_DextMod)
        ...
        self.checkBox_4 = QtWidgets.QCheckBox(self.frame_ConstMod)
        ...
        self.checkBox_5 = QtWidgets.QCheckBox(self.frame_IntelMod)
        self.checkBox_5.setObjectName("checkBox_5")
        self.verticalLayout_5.addWidget(self.checkBox_5)
        self.checkBox_13 = QtWidgets.QCheckBox(self.frame_IntelMod)
        self.checkBox_13.setObjectName("checkBox_13")
        self.verticalLayout_5.addWidget(self.checkBox_13)
        self.checkBox_15 = QtWidgets.QCheckBox(self.frame_IntelMod)
        ...
        self.checkBox_11 = QtWidgets.QCheckBox(self.frame_IntelMod)
        self.checkBox_11.setObjectName("checkBox_11")
        self.verticalLayout_8.addWidget(self.checkBox_11)
        self.checkBox_14 = QtWidgets.QCheckBox(self.frame_IntelMod)
        self.checkBox_14.setObjectName("checkBox_14")
        self.verticalLayout_8.addWidget(self.checkBox_14)
        self.checkBox_12 = QtWidgets.QCheckBox(self.frame_IntelMod)
        ...
        self.checkBox_6 = QtWidgets.QCheckBox(self.frame_WisdomMod)
        ...
        self.checkBox_7 = QtWidgets.QCheckBox(self.frame_CharismaMod)
        ...
        self.listWidget.setGeometry(QtCore.QRect(680, 160, 251, 171))
        self.listWidget.setObjectName("listWidget")
        self.listView = QtWidgets.QListView(self.centralwidget)
        self.listView.setGeometry(QtCore.QRect(680, 371, 251, 181))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "Saving Throws"))
        self.checkBox_2.setText(_translate("MainWindow", "Athletics"))
        self.Label_DextScore.setText(_translate("MainWindow", "Dexterity"))
        self.Label_EchoDextMod.setText(_translate("MainWindow", "-1"))
        self.checkBox_3.setText(_translate("MainWindow", "Saving Throws"))
        self.checkBox_9.setText(_translate("MainWindow", "Sleight of Hand"))
        self.checkBox_10.setText(_translate("MainWindow", "Stealth"))
        self.checkBox_8.setText(_translate("MainWindow", "Acrobatics"))
        self.Label_ConstScore.setText(_translate("MainWindow", "Constitution"))
        self.Label_EchoConstMod.setText(_translate("MainWindow", "-1"))
        self.checkBox_4.setText(_translate("MainWindow", "Saving Throws"))
        self.Label_IntelScore.setText(_translate("MainWindow", "Intelligence"))
        self.Label_EchoIntelMod.setText(_translate("MainWindow", "-1"))
        self.checkBox_5.setText(_translate("MainWindow", "Saving Throws"))
        self.checkBox_13.setText(_translate("MainWindow", "Investigation"))
        self.checkBox_15.setText(_translate("MainWindow", "Religion"))
        self.checkBox_11.setText(_translate("MainWindow", "Arcana"))
        self.checkBox_14.setText(_translate("MainWindow", "Nature"))
        self.checkBox_12.setText(_translate("MainWindow", "History"))
        self.Label_WisdomScore.setText(_translate("MainWindow", "Wisdom"))
        self.Label_EchoWisdomMod.setText(_translate("MainWindow", "-1"))
        self.checkBox_6.setText(_translate("MainWindow", "Saving Throws"))
        ...
        self.checkBox_7.setText(_translate("MainWindow", "Saving Throws"))
